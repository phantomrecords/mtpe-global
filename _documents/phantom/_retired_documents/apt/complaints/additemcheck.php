...
$sql = "SELECT id, make, model, size, note, misc1, misc2 FROM complaints WHERE make = '$_POST[make]' AND model = '$_POST[model]'";
$result = mysql_query($sql,$conn) or die(mysql_error());

//get the number of rows in the result set; should be 1 if a match
if (mysql_num_rows($result) == 1) {
   //check for product already in database. redirect if exits
    header("Location: item_exists.htm");
    exit;
...
//insert into tables
      ...
      $add_item = "INSERT INTO complaints VALUES ('', '$_POST[make]', '$_POST[model]', '$_POST[size]', '$_POST[note]', '$_POST[misc1]', '$_POST[misc2]', '')";
   ...
   <font color=#FFFFFF face=Tahoma size=1>You have successfully added the item. <a href=\"complaints.php\">Return to menu</a></font>";
